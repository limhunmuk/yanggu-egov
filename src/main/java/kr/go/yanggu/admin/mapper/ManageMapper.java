...
public interface ManageMapper {
	...
	int admin_menu_first_save(Map<String, Object> map) throws SQLException;
	int admin_menu_first_update(Map<String, Object> map) throws SQLException;
	int admin_menu_first_delete(Long seq) throws SQLException;

	int admin_menu_second_save(Map<String, Object> map) throws SQLException;
	int admin_menu_second_update(Map<String, Object> map) throws SQLException;
	int admin_menu_second_delete(Long seq) throws SQLException;

	 int admin_menu_third_save(Map<String, Object> map) throws SQLException;
	int admin_menu_third_update(Map<String, Object> map) throws SQLException;
	int admin_menu_third_delete(Long seq) throws SQLException;
}
