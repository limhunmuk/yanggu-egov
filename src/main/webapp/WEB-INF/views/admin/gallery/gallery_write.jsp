			...
			<div class="content">
				...
				<form id="frm" onsubmit="return frm_submit(this);">
					...
					<div class="write_btn align_r mt35">
						<a href="galleryList?kind=${kind}" class="btn_list">목록</a>
...
<script>
	...
	function del(){
		...
		$.ajax({
    	    ...
    	    , success : function (data) {
    	    	if(data.result != 0){
    	    		alert("삭제 성공하였습니다.");
    	    		location.href="/admin/gallery/galleryList?kind=${kind}";
    	    	}else{
    	    		alert("삭제 실패하였습니다.");
    	    	}
    	    }, error : function () {
	...
	function frm_submit(frm){
    	...
    	var url = "/admin/gallery/insertGallery";
    	
    	if("${one.seq}" != ""){
    		url = "/admin/gallery/updateGallery";
    	}
    	if(!flag){
    		return false;
    	}
