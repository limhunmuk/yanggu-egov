			...
			<div class="content">
				<div class="list"> 
					<form id="frm" name="frm" method="post">
						...
						<input type="hidden" name="subMenuNo" value="${subMenuNo}">
						<table class="search">
							<caption>검색</caption>
							<colgroup>
								<col style="width:14%;">
...
$(function(){
	...
	$('#lnb ul.menu > li').eq(0).find(' > a ').addClass('skin_bg').next().show().find('>li').eq(2).addClass('on');
...
function updateStat(seq,cnt,useDate,obj){
	...
	if(flag){
		$.ajax({
    	    url : "/admin/rental/adminRentalUpdate"
...
function moveWrite(){
	location.href="/admin/rental/rentalWrite?subMenuNo=2";
}
