				...
				<div class="write">
                    <form id="frm">
    					...
    					<div class="write_btn align_r mt35">
                            <a href="/admin/setting/member/accountlist" class="btn_list">목록</a>
...
<script>
    $(function () {
        ...
        $("#frm").submit(function(){
        	...
        	var url = "/admin/setting/member/insert";
        	
        	if("${one.seq}" != ""){
        		url = "/admin/setting/member/update";
        	}
        	if(!flag){
        		return false;
        	}
        	...
        	$.ajax({
        	    ...
        	    , success : function (data) {
        	    	if(data != 0){
        	    		location.href="/admin/setting/member/accountlist";
        	    	}else{
        	    		alert("중복된 아이디입니다");
