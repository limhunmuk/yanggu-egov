...
<script>
	...
	function del(){
		...
		$.ajax({
    	    url : "/admin/site/deleteecology"
    	    , data: {seq:"${one.seq}"}
    	    , type: 'post'
    	    , dataType: 'json'
    	    , success : function (data) {
    	    	if(data != 0){
    	    		location.href="/admin/site/ecologylist";
    	    	}else{
    	    		alert("삭제 실패하였습니다.");
    	    	}
    	    }, error : function () {
	...
	function frm_submit(frm){
    	...
    	var url = "/admin/site/insertecology";
    	
    	if("${one.seq}" != ""){
    		url = "/admin/site/updateecology";
    	}
    	if(!flag){
    		return false;
    	}
    ...
    $(function () {
        ...
        $("#file_type01").change(function(){
    		...
    		filedata.append('file_src', "ecology");
