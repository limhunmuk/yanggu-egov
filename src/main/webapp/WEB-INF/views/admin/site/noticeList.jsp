				...
				<div class="list">
					...
					<div class="search_wrap">
									...
									<c:otherwise>
										<c:forEach var="item" items="${list}" varStatus="status">		
											<tr>
												...
												<td><c:if test="${not empty item.attachment1 }"><button type="button" class="btn" onclick="fileDownLoad('notice','${item.attachment1}','${item.attachment1_org}');">Download</button></c:if></td>
												<td><c:if test="${not empty item.attachment2 }"><button type="button" class="btn" onclick="fileDownLoad('notice','${item.attachment2}','${item.attachment2_org}');">Download</button></c:if></td>
												<td><c:if test="${not empty item.attachment3 }"><button type="button" class="btn" onclick="fileDownLoad('notice','${item.attachment3}','${item.attachment3_org}');">Download</button></c:if></td>					
                        ...
                        <div class="table_btn align_r mt20 pl20">
                            <button type="button" onclick="location.href = 'noticewrite';">등록</button>
                        </div>
						<!-- 페이징 -->
