...
function initSetStatList(mydate) {
	...
	if(nowMonth=="2019-12"){
		...
		$.post( "/sports/reserve_state_list", "pickDate="+mydate+"&cate2="+_cate2 , function(result) {
			str += "<div class=\"state_wrap\"> ";
			for(var i=0;i<result.length;i++){
				...
				if(mydate>=_today){
					if(result[i].yesno == '0'){
						str += "<p><span style='cursor:pointer;' onclick=\"location='/sports/reserve_date?cate1="+_cate1+"&cate2="+_cate2+"'\">"+result[i].hourBeginEnd+" <span class='tbe296'>"+label+"</span></span></p> ";
					}else{
